    ...
    <div class="query-form">
      <el-form ref="form" :inline="true" :model="queryForm">
        ...
        <el-form-item>
          ...
          <el-button @click="handleReset(form.value)">重置</el-button>
        </el-form-item>
      </el-form>
    </div>
...
export default {
  ...
  setup() {
    ...
    const getApplyList = async () => {
      ...
      let { list, page } = await ctx.$api.leave.getApplyList(params);
      ...
      dialogForm.value.validate(async (valid) => {
        if (valid) {
          try {
            ...
            let res = await ctx.$api.leave.leaveOperate(params);
